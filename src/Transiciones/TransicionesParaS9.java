...
public class TransicionesParaS9 {
    ...
    public static ArrayList<String> usarTransicionS9() {
        ArrayList<String> transiciones = new ArrayList<>();
        if (transicionA_Usar == 1) {//Ingresa por primera vez a el metodo
            AnalizadorSintactico.pilasUsadas.add(new RecolectorDePilas(AnalizadorSintactico.pila, "S9"));//Se anade la pila con la que se entra al metodo
